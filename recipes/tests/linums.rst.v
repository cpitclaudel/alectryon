...
To run::
   ...
   alectryon linums.rst.v --frontend coq -o /dev/null \
     2> linums.v.out; echo "exit: $?" >> linums.v.out
       # Plain Coq → HTML + errors; produces ‘linums.v.out’

   alectryon linums.rst.v -o /dev/null \
     2> linums.v+rst.out; echo "exit: $?" >> linums.rst.v.out
