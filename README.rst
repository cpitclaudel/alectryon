...
2. Add your language's file extensions to ``core.EXTENSIONS_BY_LANGUAGE``::
...
- Pim Otte. `Waterproof Tutorial rendered using Alectryon <https://impermeable.github.io/waterproof-alectryon-example/>`__.
